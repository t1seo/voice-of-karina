...
Output checks cover decodability, silence, duration, clipping, and ASR text comparison. Missing or uncertain transcription is reported as unverified. These checks do not prove naturalness or celebrity similarity: listen before choosing a result. Speaking-rate and emotion edits of saved voices are not exposed by the current adapter.
